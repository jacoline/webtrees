...
case 'update':
	...
	$WT_TREE->preference('ADVANCED_NAME_FACTS',          WT_Filter::post('ADVANCED_NAME_FACTS'));
	$WT_TREE->preference('ADVANCED_PLAC_FACTS',          WT_Filter::post('ADVANCED_PLAC_FACTS'));
	$WT_TREE->preference('ALLOW_THEME_DROPDOWN',         WT_Filter::postBool('ALLOW_THEME_DROPDOWN'));
	$WT_TREE->preference('CALENDAR_FORMAT',              implode('_and_', array_unique(array(
	...
	$WT_TREE->preference('CHART_BOX_TAGS',               WT_Filter::post('CHART_BOX_TAGS'));
	$WT_TREE->preference('COMMON_NAMES_ADD',             str_replace(' ', '', WT_Filter::post('COMMON_NAMES_ADD')));
	$WT_TREE->preference('COMMON_NAMES_REMOVE',          str_replace(' ', '', WT_Filter::post('COMMON_NAMES_REMOVE')));
	$WT_TREE->preference('COMMON_NAMES_THRESHOLD',       WT_Filter::post('COMMON_NAMES_THRESHOLD', WT_REGEX_INTEGER, 40));
	$WT_TREE->preference('CONTACT_USER_ID',              WT_Filter::post('CONTACT_USER_ID'));
	$WT_TREE->preference('DEFAULT_PEDIGREE_GENERATIONS', WT_Filter::post('DEFAULT_PEDIGREE_GENERATIONS'));
	$WT_TREE->preference('EXPAND_NOTES',                 WT_Filter::postBool('EXPAND_NOTES'));
	$WT_TREE->preference('EXPAND_RELATIVES_EVENTS',      WT_Filter::postBool('EXPAND_RELATIVES_EVENTS'));
	$WT_TREE->preference('EXPAND_SOURCES',               WT_Filter::postBool('EXPAND_SOURCES'));
	$WT_TREE->preference('FAM_FACTS_ADD',                str_replace(' ', '', WT_Filter::post('FAM_FACTS_ADD')));
	$WT_TREE->preference('FAM_FACTS_QUICK',              str_replace(' ', '', WT_Filter::post('FAM_FACTS_QUICK')));
	$WT_TREE->preference('FAM_FACTS_UNIQUE',             str_replace(' ', '', WT_Filter::post('FAM_FACTS_UNIQUE')));
	$WT_TREE->preference('FAM_ID_PREFIX',                WT_Filter::post('FAM_ID_PREFIX'));
	$WT_TREE->preference('FULL_SOURCES',                 WT_Filter::postBool('FULL_SOURCES'));
	$WT_TREE->preference('FORMAT_TEXT',                  WT_Filter::post('FORMAT_TEXT'));
	$WT_TREE->preference('GEDCOM_ID_PREFIX',             WT_Filter::post('GEDCOM_ID_PREFIX'));
	$WT_TREE->preference('GEDCOM_MEDIA_PATH',            WT_Filter::post('GEDCOM_MEDIA_PATH'));
	$WT_TREE->preference('GENERATE_UIDS',                WT_Filter::postBool('GENERATE_UIDS'));
	$WT_TREE->preference('GEONAMES_ACCOUNT',             WT_Filter::post('GEONAMES_ACCOUNT'));
	$WT_TREE->preference('HIDE_GEDCOM_ERRORS',           WT_Filter::postBool('HIDE_GEDCOM_ERRORS'));
	$WT_TREE->preference('GEDCOM_MEDIA_PATH',            WT_Filter::post('GEDCOM_MEDIA_PATH'));
	$WT_TREE->preference('INDI_FACTS_ADD',               str_replace(' ', '', WT_Filter::post('INDI_FACTS_ADD')));
	$WT_TREE->preference('INDI_FACTS_QUICK',             str_replace(' ', '', WT_Filter::post('INDI_FACTS_QUICK')));
	$WT_TREE->preference('INDI_FACTS_UNIQUE',            str_replace(' ', '', WT_Filter::post('INDI_FACTS_UNIQUE')));
	$WT_TREE->preference('LANGUAGE',                     WT_Filter::post('LANGUAGE'));
	$WT_TREE->preference('MAX_DESCENDANCY_GENERATIONS',  WT_Filter::post('MAX_DESCENDANCY_GENERATIONS'));
	$WT_TREE->preference('MAX_PEDIGREE_GENERATIONS',     WT_Filter::post('MAX_PEDIGREE_GENERATIONS'));
	$WT_TREE->preference('MEDIA_ID_PREFIX',              WT_Filter::post('MEDIA_ID_PREFIX'));
	$WT_TREE->preference('MEDIA_UPLOAD',                 WT_Filter::post('MEDIA_UPLOAD'));
	$WT_TREE->preference('META_DESCRIPTION',             WT_Filter::post('META_DESCRIPTION'));
	$WT_TREE->preference('META_TITLE',                   WT_Filter::post('META_TITLE'));
	$WT_TREE->preference('NOTE_ID_PREFIX',               WT_Filter::post('NOTE_ID_PREFIX'));
	$WT_TREE->preference('NO_UPDATE_CHAN',               WT_Filter::postBool('NO_UPDATE_CHAN'));
	$WT_TREE->preference('PEDIGREE_FULL_DETAILS',        WT_Filter::postBool('PEDIGREE_FULL_DETAILS'));
	$WT_TREE->preference('PEDIGREE_LAYOUT',              WT_Filter::postBool('PEDIGREE_LAYOUT'));
	$WT_TREE->preference('PEDIGREE_ROOT_ID',             WT_Filter::post('PEDIGREE_ROOT_ID', WT_REGEX_XREF));
	$WT_TREE->preference('PEDIGREE_SHOW_GENDER',         WT_Filter::postBool('PEDIGREE_SHOW_GENDER'));
	$WT_TREE->preference('PREFER_LEVEL2_SOURCES',        WT_Filter::post('PREFER_LEVEL2_SOURCES'));
	$WT_TREE->preference('QUICK_REQUIRED_FACTS',         WT_Filter::post('QUICK_REQUIRED_FACTS'));
	$WT_TREE->preference('QUICK_REQUIRED_FAMFACTS',      WT_Filter::post('QUICK_REQUIRED_FAMFACTS'));
	$WT_TREE->preference('REPO_FACTS_ADD',               str_replace(' ', '', WT_Filter::post('REPO_FACTS_ADD')));
	$WT_TREE->preference('REPO_FACTS_QUICK',             str_replace(' ', '', WT_Filter::post('REPO_FACTS_QUICK')));
	$WT_TREE->preference('REPO_FACTS_UNIQUE',            str_replace(' ', '', WT_Filter::post('REPO_FACTS_UNIQUE')));
	$WT_TREE->preference('REPO_ID_PREFIX',               WT_Filter::post('REPO_ID_PREFIX'));
	$WT_TREE->preference('SAVE_WATERMARK_IMAGE',         WT_Filter::postBool('SAVE_WATERMARK_IMAGE'));
	$WT_TREE->preference('SAVE_WATERMARK_THUMB',         WT_Filter::postBool('SAVE_WATERMARK_THUMB'));
	$WT_TREE->preference('SHOW_AGE_DIFF',                WT_Filter::postBool('SHOW_AGE_DIFF'));
	$WT_TREE->preference('SHOW_COUNTER',                 WT_Filter::postBool('SHOW_COUNTER'));
	$WT_TREE->preference('SHOW_EST_LIST_DATES',          WT_Filter::postBool('SHOW_EST_LIST_DATES'));
	$WT_TREE->preference('SHOW_FACT_ICONS',              WT_Filter::postBool('SHOW_FACT_ICONS'));
	$WT_TREE->preference('SHOW_GEDCOM_RECORD',           WT_Filter::postBool('SHOW_GEDCOM_RECORD'));
	$WT_TREE->preference('SHOW_HIGHLIGHT_IMAGES',        WT_Filter::postBool('SHOW_HIGHLIGHT_IMAGES'));
	$WT_TREE->preference('SHOW_LAST_CHANGE',             WT_Filter::postBool('SHOW_LAST_CHANGE'));
	$WT_TREE->preference('SHOW_LDS_AT_GLANCE',           WT_Filter::postBool('SHOW_LDS_AT_GLANCE'));
	$WT_TREE->preference('SHOW_LEVEL2_NOTES',            WT_Filter::postBool('SHOW_LEVEL2_NOTES'));
	$WT_TREE->preference('SHOW_MEDIA_DOWNLOAD',          WT_Filter::postBool('SHOW_MEDIA_DOWNLOAD'));
	$WT_TREE->preference('SHOW_NO_WATERMARK',            WT_Filter::post('SHOW_NO_WATERMARK'));
	$WT_TREE->preference('SHOW_PARENTS_AGE',             WT_Filter::postBool('SHOW_PARENTS_AGE'));
	$WT_TREE->preference('SHOW_PEDIGREE_PLACES',         WT_Filter::post('SHOW_PEDIGREE_PLACES'));
	$WT_TREE->preference('SHOW_PEDIGREE_PLACES_SUFFIX',  WT_Filter::postBool('SHOW_PEDIGREE_PLACES_SUFFIX'));
	$WT_TREE->preference('SHOW_RELATIVES_EVENTS',        implode(',', WT_Filter::postArray('SHOW_RELATIVES_EVENTS')));
	$WT_TREE->preference('SHOW_STATS',                   WT_Filter::postBool('SHOW_STATS'));
	$WT_TREE->preference('SOURCE_ID_PREFIX',             WT_Filter::post('SOURCE_ID_PREFIX'));
	$WT_TREE->preference('SOUR_FACTS_ADD',               str_replace(' ', '', WT_Filter::post('SOUR_FACTS_ADD')));
	$WT_TREE->preference('SOUR_FACTS_QUICK',             str_replace(' ', '', WT_Filter::post('SOUR_FACTS_QUICK')));
	$WT_TREE->preference('SOUR_FACTS_UNIQUE',            str_replace(' ', '', WT_Filter::post('SOUR_FACTS_UNIQUE')));
	$WT_TREE->preference('SUBLIST_TRIGGER_I',            WT_Filter::post('SUBLIST_TRIGGER_I', WT_REGEX_INTEGER, 200));
	$WT_TREE->preference('SURNAME_LIST_STYLE',           WT_Filter::post('SURNAME_LIST_STYLE'));
	$WT_TREE->preference('SURNAME_TRADITION',            WT_Filter::post('SURNAME_TRADITION'));
	$WT_TREE->preference('THEME_DIR',                    WT_Filter::post('THEME_DIR'));
	$WT_TREE->preference('THUMBNAIL_WIDTH',              WT_Filter::post('THUMBNAIL_WIDTH'));
	$WT_TREE->preference('USE_RIN',                      WT_Filter::postBool('USE_RIN'));
	$WT_TREE->preference('USE_SILHOUETTE',               WT_Filter::postBool('USE_SILHOUETTE'));
	$WT_TREE->preference('WATERMARK_THUMB',              WT_Filter::postBool('WATERMARK_THUMB'));
	$WT_TREE->preference('WEBMASTER_USER_ID',            WT_Filter::post('WEBMASTER_USER_ID'));
	$WT_TREE->preference('WEBTREES_EMAIL',               WT_Filter::post('WEBTREES_EMAIL'));
	$WT_TREE->preference('WORD_WRAPPED_NOTES',           WT_Filter::postBool('WORD_WRAPPED_NOTES'));
	if (WT_Filter::post('title')) {
		$WT_TREE->preference('title',                    WT_Filter::post('title'));
	}
	...
	if ($MEDIA_DIRECTORY) {
		if (is_dir(WT_DATA_DIR . $MEDIA_DIRECTORY)) {
			$WT_TREE->preference('MEDIA_DIRECTORY', $MEDIA_DIRECTORY);
		} elseif (@mkdir(WT_DATA_DIR . $MEDIA_DIRECTORY, 0755, true)) {
			$WT_TREE->preference('MEDIA_DIRECTORY', $MEDIA_DIRECTORY);
	...
	header('Location: ' . WT_SERVER_NAME . WT_SCRIPT_PATH . 'admin_trees_manage.php?ged=' . $gedcom);
	exit;
}
...
$relatives_events = explode(',', get_gedcom_setting(WT_GED_ID, 'SHOW_RELATIVES_EVENTS'));
...
<form class="form-horizontal" method="POST" role="form">
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="title">
			<?php echo /* I18N: A configuration setting */ WT_I18N::translate('Family tree title'); ?>
		</label>
		<div class="col-sm-9">
			<input
				class="form-control"
				...
				required
				type="text"
				value="<?php echo WT_Filter::escapeHtml(get_gedcom_setting(WT_GED_ID, 'title')); ?>"
				>
		</div>
	</div>
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="gedcom">
			<?php echo /* I18N: A configuration setting */ WT_I18N::translate('URL'); ?>
		</label>
		<div class="col-sm-9">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo select_edit_control('LANGUAGE', WT_I18N::installed_languages(), null, get_gedcom_setting(WT_GED_ID, 'LANGUAGE'), 'class="form-control"'); ?>
			<p class="small text-muted">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo get_gedcom_setting(WT_GED_ID, 'PEDIGREE_ROOT_ID'); ?>"
				>
				<span class="input-group-addon">
					<?php
					$person = WT_Individual::getInstance($WT_TREE->preference('PEDIGREE_ROOT_ID'));
					if ($person) {
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('USE_RIN', $no_yes, $WT_TREE->preference('USE_RIN'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('GENERATE_UIDS', $no_yes, $WT_TREE->preference('GENERATE_UIDS'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('WORD_WRAPPED_NOTES', $no_yes, $WT_TREE->preference('WORD_WRAPPED_NOTES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
				...
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input
							...
							type="text"
							value="<?php echo $WT_TREE->preference('GEDCOM_ID_PREFIX'); ?>"
							>
					</div>
				</div>
				<!-- FAM_ID_PREFIX -->
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input
							...
							name="FAM_ID_PREFIX"
							type="text"
							value="<?php echo $WT_TREE->preference('FAM_ID_PREFIX'); ?>"
							>
					</div>
				</div>
				<!-- SOURCE_ID_PREFIX -->
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input
							...
							type="text"
							value="<?php echo $WT_TREE->preference('SOURCE_ID_PREFIX'); ?>"
							>
					</div>
				</div>
				<!-- REPO_ID_PREFIX -->
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input
							...
							name="REPO_ID_PREFIX"
							type="text"
							value="<?php echo $WT_TREE->preference('REPO_ID_PREFIX'); ?>"
							>
					</div>
				</div>
				<!-- MEDIA_ID_PREFIX -->
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input
							...
							type="text"
							value="<?php echo $WT_TREE->preference('MEDIA_ID_PREFIX'); ?>"
							>
					</div>
				</div>
				<!-- NOTE_ID_PREFIX -->
				<div class="col-sm-4">
					<div class="input-group">
						...
						<input
							...
							name="NOTE_ID_PREFIX"
							type="text"
							value="<?php echo $WT_TREE->preference('NOTE_ID_PREFIX'); ?>"
							>
					</div>
				</div>
			</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				name="WEBTREES_EMAIL"
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('WEBTREES_EMAIL')); ?>"
				>
			<p class="small text-muted">
		...
		<div class="col-sm-9">
			<select id="CONTACT_USER_ID" name="CONTACT_USER_ID" class="form-control">
				<?php foreach (User::allVerified() as $user): ?>
					<option value="<?php echo $user->getUserId(); ?>" selected="<?php echo $WT_TREE->preference('CONTACT_USER_ID') === $user->getUserId() ? 'selected' : ''; ?>">
		...
		<div class="col-sm-9">
			<select id="WEBMASTER_USER_ID" name="WEBMASTER_USER_ID" class="form-control">
				<?php foreach (User::allAdmins() as $user): ?>
					<option value="<?php echo $user->getUserId(); ?>" selected="<?php echo $WT_TREE->preference('WEBMASTER_USER_ID') === $user->getUserId() ? 'selected' : ''; ?>">
						<?php echo WT_Filter::escapeHtml($user->getRealName()) . ' - ' . WT_Filter::escapeHtml($user->getUserName()); ?>
					</option>
				<?php endforeach; ?>
			</select>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				name="META_TITLE"
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('META_TITLE')); ?>"
				>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('META_DESCRIPTION')); ?>"
				>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('ALLOW_THEME_DROPDOWN', $hide_show, $WT_TREE->preference('ALLOW_THEME_DROPDOWN'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo select_edit_control('THEME_DIR', get_theme_names(),WT_I18N::translate('<default theme>'), $WT_TREE->preference('THEME_DIR'), 'class="form-control"'); ?>
			<p class="small text-muted">
		...
		<div class="col-sm-9">
			<div class="input-group">
				...
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('MEDIA_DIRECTORY')); ?>"
				>
			</div>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('GEDCOM_MEDIA_PATH')); ?>"
				>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo select_edit_control('MEDIA_UPLOAD', array(WT_PRIV_USER=>WT_I18N::translate('Show to members'),
				WT_PRIV_NONE=>WT_I18N::translate('Show to managers'), WT_PRIV_HIDE=>WT_I18N::translate('Hide from everyone')), null, $WT_TREE->preference('MEDIA_UPLOAD'), 'class="form-control"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_MEDIA_DOWNLOAD', $no_yes, $WT_TREE->preference('SHOW_MEDIA_DOWNLOAD'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					required
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('THUMBNAIL_WIDTH')); ?>"
					>
				<span class="input-group-addon">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('USE_SILHOUETTE', $no_yes, $WT_TREE->preference('USE_SILHOUETTE'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		<legend class="control-label col-sm-3">
			<?php echo /* I18N: A configuration setting */ WT_I18N::translate('Show highlight images in individual boxes'); ?>
		</legend>
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_HIGHLIGHT_IMAGES', $no_yes, $WT_TREE->preference('SHOW_HIGHLIGHT_IMAGES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
			</p>
		</div>
	</fieldset>
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('WATERMARK_THUMB', $no_yes, $WT_TREE->preference('WATERMARK_THUMB'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SAVE_WATERMARK_IMAGE', $no_yes, $WT_TREE->preference('SAVE_WATERMARK_IMAGE'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SAVE_WATERMARK_THUMB', $no_yes, $WT_TREE->preference('SAVE_WATERMARK_THUMB'), 'class="radio-inline"'); ?>
		</div>
	</fieldset>
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="SHOW_NO_WATERMARK">
			<?php echo /* I18N: A configuration setting */ WT_I18N::translate('Images without watermarks'); ?>
		</label>
		<div class="col-sm-9">
			<?php echo select_edit_control('SHOW_NO_WATERMARK', $privacy, null, $WT_TREE->preference('MEDIA_UPLOAD'), 'class="form-control"'); ?>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				required
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('COMMON_NAMES_THRESHOLD')); ?>"
				>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('COMMON_NAMES_ADD')); ?>"
				>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('COMMON_NAMES_REMOVE')); ?>"
				>
			<p class="small text-muted">
	...
	<div class="form-group">
		<label class="control-label col-sm-3" for="SURNAME_LIST_STYLE">
			<?php echo /* I18N: A configuration setting */ WT_I18N::translate('Surname list style'); ?>
		</label>
		<div class="col-sm-9">
			<?php echo select_edit_control('SURNAME_LIST_STYLE', $surname_list_styles, null, $WT_TREE->preference('SURNAME_LIST_STYLE'), 'class="form-control"'); ?>
			<p class="small text-muted">
			</p>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				required
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('SUBLIST_TRIGGER_I')); ?>"
				>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_EST_LIST_DATES', $hide_show, $WT_TREE->preference('SHOW_EST_LIST_DATES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		<legend class="control-label col-sm-3">
			<?php echo /* I18N: A configuration setting */ WT_I18N::translate('The date and time of the last update'); ?>
		</legend>
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_LAST_CHANGE', $hide_show, $WT_TREE->preference('SHOW_LAST_CHANGE'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
			</p>
		</div>
	</fieldset>
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('PEDIGREE_LAYOUT', $layouts, $WT_TREE->preference('PEDIGREE_LAYOUT'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
			</p>
		</div>
	</fieldset>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				required
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('DEFAULT_PEDIGREE_GENERATIONS')); ?>"
				>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('MAX_PEDIGREE_GENERATIONS')); ?>"
				>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('MAX_DESCENDANCY_GENERATIONS')); ?>"
				>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('EXPAND_RELATIVES_EVENTS', $no_yes, $WT_TREE->preference('EXPAND_RELATIVES_EVENTS'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
		...
		<div class="col-sm-9">
			<?php echo /* I18N: The placeholders are edit controls.  Show the [first/last] [1/2/3/4/5] parts of a place name */ WT_I18N::translate(
				...
				select_edit_control('SHOW_PEDIGREE_PLACES_SUFFIX',
					...
					null,
					$WT_TREE->preference('SHOW_PEDIGREE_PLACES_SUFFIX')
				),
				select_edit_control('SHOW_PEDIGREE_PLACES', $one_to_nine, null, $WT_TREE->preference('SHOW_PEDIGREE_PLACES')
				)
			);
			?>
			<p class="small text-muted">
	...
	<h3><?php echo WT_I18N::translate('Format'); ?></h3>
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('FORMAT_TEXT', $formats, $WT_TREE->preference('FORMAT_TEXT'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('PEDIGREE_FULL_DETAILS', $no_yes, $WT_TREE->preference('PEDIGREE_FULL_DETAILS'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('PEDIGREE_SHOW_GENDER', $hide_show, $WT_TREE->preference('PEDIGREE_SHOW_GENDER'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_PARENTS_AGE', $hide_show, $WT_TREE->preference('SHOW_PARENTS_AGE'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_LDS_AT_GLANCE', $hide_show, $WT_TREE->preference('SHOW_LDS_AT_GLANCE'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="CHART_BOX_TAGS"
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('CHART_BOX_TAGS')); ?>"
					>
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_FACT_ICONS', $hide_show, $WT_TREE->preference('SHOW_FACT_ICONS'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('EXPAND_NOTES', $no_yes, $WT_TREE->preference('EXPAND_NOTES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('EXPAND_SOURCES', $no_yes, $WT_TREE->preference('EXPAND_SOURCES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_LEVEL2_NOTES', $no_yes, $WT_TREE->preference('SHOW_LEVEL2_NOTES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_AGE_DIFF', $hide_show, $WT_TREE->preference('SHOW_AGE_DIFF'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_GEDCOM_RECORD', $no_yes, $WT_TREE->preference('SHOW_GEDCOM_RECORD'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('HIDE_GEDCOM_ERRORS', $hide_show, $WT_TREE->preference('HIDE_GEDCOM_ERRORS'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_COUNTER', $hide_show, $WT_TREE->preference('SHOW_COUNTER'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SHOW_STATS', $hide_show, $WT_TREE->preference('SHOW_STATS'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="INDI_FACTS_ADD"
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('INDI_FACTS_ADD')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('INDI_FACTS_UNIQUE')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('QUICK_REQUIRED_FACTS')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('INDI_FACTS_QUICK')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="FAM_FACTS_ADD"
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('FAM_FACTS_ADD')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('FAM_FACTS_UNIQUE')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('QUICK_REQUIRED_FAMFACTS')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('FAM_FACTS_QUICK')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="SOUR_FACTS_ADD"
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('SOUR_FACTS_ADD')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('SOUR_FACTS_UNIQUE')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('SOUR_FACTS_QUICK')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					name="REPO_FACTS_ADD"
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('REPO_FACTS_ADD')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('REPO_FACTS_UNIQUE')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('REPO_FACTS_QUICK')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('ADVANCED_NAME_FACTS')); ?>"
					>
				<div class="input-group-btn">
		...
		<div class="col-sm-9">
			<div class="input-group">
				<input
					...
					type="text"
					value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('ADVANCED_PLAC_FACTS')); ?>"
					>
				<div class="input-group-btn">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('SURNAME_TRADITION', $surname_traditions, $WT_TREE->preference('SURNAME_TRADITION'), 'class="radio-inline" style="display: block;"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('FULL_SOURCES', $no_yes, $WT_TREE->preference('FULL_SOURCES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('PREFER_LEVEL2_SOURCES', $source_types, $WT_TREE->preference('PREFER_LEVEL2_SOURCES'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input
				...
				type="text"
				value="<?php echo WT_Filter::escapeHtml($WT_TREE->preference('GEONAMES_ACCOUNT')); ?>"
				>
			<p class="small text-muted">
	...
	<fieldset class="form-group">
		...
		<div class="col-sm-9">
			<?php echo radio_buttons('NO_UPDATE_CHAN', $no_yes, $WT_TREE->preference('NO_UPDATE_CHAN'), 'class="radio-inline"'); ?>
			<p class="small text-muted">
